...
<script type="text/javascript">
	...
	function start(id) {
		...
		AJAX.call("chemical_fetch_paging.jsp", params, function (data) {
				...
				if (startPage > 1) {
					pagingDiv.append('<a href="chemical_main.jsp?paging=1">처음</a>');
				}
				if (paging > 1) {
					pagingDiv.append('<a href="chemical_main.jsp?paging=' + (paging - 1) + '">이전</a>');
				}
				...
				if (paging < totalPage) {
					pagingDiv.append('<a href="chemical_main.jsp?paging=' + (paging + 1) + '">다음</a>');
				}
				if (endPage < totalPage) {
					pagingDiv.append('<a href="chemical_main.jsp?paging=' + (totalPage) + '">끝</a>');
				}
			}
		);
	}
