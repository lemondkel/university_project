...
<%
	...
	try {
		String id = null, desc = null, title = null, material = null, hashtag = null;
		...
		String sql = "INSERT INTO info(id, jsonobj, title, material, hashtag, type) VALUES('" + id + "', '" + jsonobj.toJSONString() + "', '" + title + "', '" + material + "', '" + hashtag + "', 0)";
