...
<%
	...
	try {
		String id = null, desc = null, no = null, title = null, material = null, hashtag = null;
		...
		String sql = "SELECT jsonobj FROM feed WHERE no = " + no;
		...
		sql = "UPDATE info SET jsonobj='" + jsonobj.toJSONString() + "', title='" + title + "', material='" + material + "', hashtag='" + hashtag + "' WHERE no=" + no;
