...
<div id="contents-area" class="section">
	<div class="form">
		<textarea id="--desc" class="form-mtxt" rows=5 placeholder="답변 내용을 작성해주세요."></textarea>
		<input type="submit" value="답변글을 작성합니다." onclick="answer(<%=request.getParameter("no")%>)">
	</div>
...
<script type="text/javascript">
	...
	function answer(no) {
		...
		AJAX.formCall("qna_answer_process.jsp", params, function (data) {
			alert("답변글을 작성하였습니다.");
			history.back();
		});
	}
